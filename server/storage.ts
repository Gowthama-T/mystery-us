...
const schedulesData: Schedule[] = [
  {
    ...
    color: "neon-gold",
    events: [
      { time: "9:00 AM", title: "Arrival & Registration", description: "Check-in and welcome" },
      { time: "10:00 AM", title: "Inauguration Ceremony", description: "Official event opening" },
      { time: "11:00 AM", title: "Cultural Performances", description: "Traditional dance & music" },
      { time: "1:00 PM", title: "Lunch Break", description: "Traditional delicacies" },
      { time: "2:30 PM", title: "Photo Sessions", description: "Group photos in ethnic wear" },
      { time: "4:00 PM", title: "Traditional Games", description: "Fun cultural activities" },
      { time: "5:30 PM", title: "Closing & Awards", description: "Best dressed awards" },
    ],
  },
  {
    id: 2,
